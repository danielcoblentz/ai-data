...
vs.stop()
# Copied from homework/ASL Code/recognize.py
# Keep original in place; this is a copy for easier import path organization.

# USAGE
# python recognize_regular.py --conf config/config.json

# This file is a lightweight copy placeholder. If you want, I can copy full content.
